...
class EditForm(forms.Form):
    username = forms.CharField(label="Votre nouveau nom d'utilisateur", max_length=30)
    password = forms.CharField(label="Votre nouveau mot de passe", widget=forms.PasswordInput)
    passwordVerif = forms.CharField(label="Contrôle du mot de passe (saisir le même mot de passe", max_length=30, min_length=8)